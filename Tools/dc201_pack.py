...
class DC201ErrorCode(Enum):
    ...
    eError_Comm_Main_Busy = ("串口发送忙", 36)
    eError_Comm_Main_Send_Failed = ("发送失败", 37)
    eError_Comm_Main_Not_ACK = ("没有收到ACK", 38)
    eError_Comm_Main_Wrong_ID = ("异常ID", 39)
    eError_Comm_Main_Unknow_CMD = ("异常功能码", 40)
    eError_Comm_Main_Param_Error = ("报文参数异常", 41)
    eError_Comm_Data_Busy = ("串口发送忙", 42)
    eError_Comm_Data_Send_Failed = ("发送失败", 43)
    eError_Comm_Data_Not_ACK = ("没有收到ACK", 44)
    eError_Comm_Data_Wrong_ID = ("异常ID", 45)
    eError_Comm_Data_Unknow_CMD = ("异常功能码", 46)
    eError_Comm_Data_Param_Error = ("报文参数异常", 47)
    eError_Comm_Out_Busy = ("串口发送忙", 48)
    eError_Comm_Out_Send_Failed = ("发送失败", 49)
    eError_Comm_Out_Not_ACK = ("没有收到ACK", 50)
    eError_Comm_Out_Wrong_ID = ("异常ID", 51)
    eError_Comm_Out_Unknow_CMD = ("异常功能码", 52)
    eError_Comm_Out_Param_Error = ("报文参数异常", 53)
