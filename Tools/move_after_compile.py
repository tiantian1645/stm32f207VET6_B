...
def main():
    ...
    for fn in os.listdir(target_dir):
        if fn.startswith("stm32f207VET6_B-"):
            ...
            os.remove(file_path)
    shutil.move("../Debug/stm32f207VET6_B.bin", f"{target_dir}stm32f207VET6_B-v{version_str}.bin")
    shutil.move("../Debug/stm32f207VET6_B.hex", f"{target_dir}stm32f207VET6_B-v{version_str}.hex")
